...
const CreateCampaignContainer = (props) => {
    ...
    const handleFormSubmit = (e) => {
        e.preventDefault();
        createCampaign(campaignName.current.value, minimumContribution.current.value);
    };
                ...
                <div className="col-4 pl-0 mt-2">
                    ...
                    <Form.Group controlId="formMinContribution">
                            ...
                            <InputGroup className="">
                                <Form.Control type="text" placeholder="Enter campaign name" ref={campaignName} required />
                            </InputGroup>
                        </Form.Group>
                        <Form.Group controlId="formMinContribution">
